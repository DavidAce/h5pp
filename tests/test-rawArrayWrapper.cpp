...
#include <h5pp/details/h5ppPtrWrapper.h>
#include <h5pp/details/h5ppTypeSfinae.h>
#include <iostream>
...
int main() {
    ...
    auto wrapped_arr1 = h5pp::PtrWrapper(arr1, dims1);
    auto wrapped_arr2 = h5pp::PtrWrapper(arr2, dims2);
    auto wrapped_arr3 = h5pp::PtrWrapper(arr2, {3, 3, 3});
    ...
    auto                wrapped_arr4 = h5pp::PtrWrapper(data.data(), dims);
