...
int main() {
    ...
    auto dsetInfo = file.writeDataset(fill, "dset_direct", H5D_CHUNKED, {12, 12}, {3, 3}, {12, 12}, std::nullopt, std::nullopt, 9);
    ...
    h5pp::hdf5::H5Dwrite_chunkwise(data, dataInfo, dsetInfo, file.plists);
