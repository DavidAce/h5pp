...
int main() {
    size_t     logLevel = 0;
    h5pp::File fileA("output/moveLinkA.h5", h5pp::FileAccess::REPLACE, logLevel);
    // Same file
    ...
    // Different file
    fileA.moveLinkToFile("groupA/A", "output/moveLinkB.h5", "groupA_from_file_A/A", h5pp::FileAccess::REPLACE);
