...
int main() {
    ...
    h5pp::v1::File fileA(H5PP_EXAMPLE_DIR "example-07d-copy-dset-file2file-A.h5", h5pp::FileAccess::REPLACE, logLevel);
    h5pp::v1::File fileB(H5PP_EXAMPLE_DIR "example-07d-copy-dset-file2file-B.h5", h5pp::FileAccess::REPLACE, logLevel);
