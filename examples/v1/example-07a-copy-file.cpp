...
int main() {
    ...
    // Initialize a file
    h5pp::v1::File file(H5PP_EXAMPLE_DIR "example-07a-copy-file.h5", h5pp::FileAccess::REPLACE, logLevel);
    ...
    file.copyFileTo(H5PP_EXAMPLE_DIR "subdir/example-step7-copy-file.h5", h5pp::FileAccess::REPLACE);
