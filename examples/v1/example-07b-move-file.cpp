...
int main() {
    ...
    // Initialize a file
    h5pp::v1::File file(H5PP_EXAMPLE_DIR "example-07b-move-file.h5", h5pp::FileAccess::REPLACE, logLevel);
    ...
    file.moveFileTo(H5PP_EXAMPLE_DIR "subdir/example-step7-move-file.h5", h5pp::FileAccess::REPLACE);
