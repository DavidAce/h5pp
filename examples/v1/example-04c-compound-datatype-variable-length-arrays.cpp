...
struct Volcano {
    ...
    // when reading this type of data. To disable tracking completely, use h5pp::v1::File::vlenDisableReclaimsTracking() instead.
...
int main() {
    ...
    h5pp::v1::File file(H5PP_EXAMPLE_DIR "example-04c-compound-datatype-variable-length-arrays.h5", h5pp::FileAccess::REPLACE, logLevel);
