...
void writeThenRead(h5pp::v1::File &file, const std::vector<ScalarN> &dset, std::string_view dsetName) {
    // Write data
...
int main() {
    // Initialize a file
    h5pp::v1::File file(H5PP_EXAMPLE_DIR "example-02d-stdvector-struct.h5", h5pp::FileAccess::REPLACE);
