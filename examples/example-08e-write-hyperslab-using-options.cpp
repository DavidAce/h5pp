...
int main() {
    // Initialize a file
    h5pp::File file("exampledir/example-08b-write-hyperslab-using-options.h5", h5pp::FilePermission::REPLACE);
    ...
    // 1) Define a hyperslab and give it to .writeDataset(...). (simplest)
