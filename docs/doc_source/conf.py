...
project = u'h5pp'
copyright = u'2020-present, David Ace'
...
man_pages = [
    ('index', 'h5pp', u'h5pp documentation', [u'David Ace'], 1)
]
...
texinfo_documents = [
  ('index', 'h5pp', u'h5pp documentation',
   u'David Ace', 'h5pp', 'One line description of project.',
   'Miscellaneous'),
]
