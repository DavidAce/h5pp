...
#envs/bin dmrg/bin envs/dmrg/bin
#envs/bin dmrg/bin envs/dmrg/bin
...
#        if(NOT HDF5_FOUND)
#            message(STATUS "Searching for hdf5 in ${HDF5_ROOT} ... execs" )
##            set(HDF5_NO_FIND_PACKAGE_CONFIG_FILE OFF)
#
#            find_package(HDF5 ${HDF5_ATLEAST_VERSION} COMPONENTS ${HDF5_MODULES})
#        endif()
#        find_package(HDF5 ${HDF5_ATLEAST_VERSION} COMPONENTS  ${HDF5_MODULES} NO_MODULE REQUIRED static)

        find_file(HDF5_C_COMPILER_EXECUTABLE    NAMES h5cc  PATHS ${HDF5_ROOT} PATH_SUFFIXES libs/hdf5/bin third-party/hdf5/bin bin   NO_DEFAULT_PATH )
        find_file(HDF5_CXX_COMPILER_EXECUTABLE  NAMES h5c++ PATHS ${HDF5_ROOT} PATH_SUFFIXES libs/hdf5/bin third-party/hdf5/bin bin   NO_DEFAULT_PATH )
        if (HDF5_FOUND OR HDF5_C_COMPILER_EXECUTABLE OR HDF5_CXX_COMPILER_EXECUTABLE)
...
#            print_target_properties(hdf5::hdf5-static)
#            print_target_properties(hdf5::hdf5-shared)
#            print_target_properties(hdf5::hdf5_cpp-static)
            if(HDF5_FOUND)
