...
#        set(HDF5_ATLEAST_VERSION 1.10)
    ...
    list(APPEND HDF5_PATHS ${H5PP_DIRECTORY_HINTS} ${HDF5_DIR} $ENV{hdf5_DIR} $ENV{HDF5_DIR} ${HDF5_ROOT} ${hdf5_DIR}  $ENV{HDF5_ROOT} $ENV{EBROOTHDF5} /usr /usr/local  ${CMAKE_INSTALL_PREFIX} )
