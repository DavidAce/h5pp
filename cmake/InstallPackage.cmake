...
function(install_package pkg_name)
    ...
    if(NOT ${pkg_name}_FOUND)
        if(${pkg_find_name}_FOUND)
            set(${pkg_name}_FOUND TRUE CACHE INTERNAL "")
        else()
    ...
    if(${pkg_name}_FOUND)
        ...
        foreach(tgt ${PKG_TARGET_HINTS})
            if(TARGET ${tgt})
                set(PKG_${pkg_name}_TARGET ${tgt} CACHE INTERNAL "")
                set(PKG_${pkg_name}_FOUND TRUE CACHE INTERNAL "")
                set(PKG_${pkg_find_name}_TARGET ${tgt} CACHE INTERNAL "")
                set(PKG_${pkg_find_name}_FOUND TRUE CACHE INTERNAL "")
                set(PKG_INSTALLED_TARGETS ${PKG_INSTALLED_TARGETS};${tgt} CACHE INTERNAL "")
