...
if(H5PP_PACKAGE_MANAGER MATCHES "cmake")
    ...
    if(NOT ZLIB_LIBRARY OR NOT ZLIB_INCLUDE_DIR)
        find_library(ZLIB_LIBRARY NAMES z zlib zlibstatic HINTS ${H5PP_DEPS_INSTALL_DIR} PATH_SUFFIXES zlib/lib NO_DEFAULT_PATH)
        ...
        if(NOT ZLIB_LIBRARY OR NOT ZLIB_INCLUDE_DIR)
            ...
            find_library(ZLIB_LIBRARY NAMES z zlib zlibstatic HINTS ${H5PP_DEPS_INSTALL_DIR} PATH_SUFFIXES zlib/lib NO_DEFAULT_PATH REQUIRED)
