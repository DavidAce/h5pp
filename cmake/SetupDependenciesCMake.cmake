...
if(H5PP_PACKAGE_MANAGER MATCHES "cmake")
    ...
    if(NOT TARGET hdf5::all)
        ...
        if(NOT TARGET hdf5::all)
            ...
            include(${PROJECT_SOURCE_DIR}/cmake/BuildDependency.cmake)
            find_library(SZIP_LIBRARY NAMES sz  HINTS ${H5PP_DEPS_INSTALL_DIR}/aec/lib NO_DEFAULT_PATH)
            find_library(AEC_LIBRARY  NAMES aec HINTS ${H5PP_DEPS_INSTALL_DIR}/aec/lib NO_DEFAULT_PATH)
            find_library(ZLIB_LIBRARY NAMES  z  HINTS ${H5PP_DEPS_INSTALL_DIR}/zlib/lib NO_DEFAULT_PATH)
            if(NOT SZIP_LIBRARY OR NOT AEC_LIBRARY)
                build_dependency(aec  "${H5PP_DEPS_INSTALL_DIR}" "")
                find_library(SZIP_LIBRARY NAMES sz  HINTS ${H5PP_DEPS_INSTALL_DIR}/aec/lib NO_DEFAULT_PATH REQUIRED)
                find_library(AEC_LIBRARY  NAMES aec HINTS ${H5PP_DEPS_INSTALL_DIR}/aec/lib NO_DEFAULT_PATH REQUIRED)
            endif()
            if(NOT ZLIB_LIBRARY)
                build_dependency(zlib "${H5PP_DEPS_INSTALL_DIR}" "")
                find_library(ZLIB_LIBRARY NAMES  z  HINTS ${H5PP_DEPS_INSTALL_DIR}/zlib/lib NO_DEFAULT_PATH REQUIRED)
            endif()
