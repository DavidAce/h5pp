...
function(find_package_hdf5_isolator hdf5_root)
    ...
    if(HDF5_FOUND)
        ...
        # Check that each link library has correct static/shared extension
        foreach(lang ${HDF5_LANG})
...
#                        list(TRANSFORM HDF5_LINK_LIBNAMES REPLACE "${lib}" "-L${HDF5_LINK_LIBNAME_${lib}_DIR}")
                        ...
                        set(ACCEPT_PACKAGE FALSE)
                        set(REJECT_REASON "HDF5 static libraries depend a shared library no static replacement could be found")
