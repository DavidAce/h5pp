...
if(H5PP_ENABLE_EIGEN3)
    ...
    if(EIGEN3_VERSION AND EIGEN3_VERSION VERSION_LESS 3.4.0)
        message(FATAL_ERROR "H5PP_ENABLE_EIGEN3: Found version ${EIGEN3_VERSION} < 3.4.0 required by h5pp")
    endif()
...
if(H5PP_ENABLE_FMT)
    ...
    if(FMT_VERSION AND FMT_VERSION VERSION_LESS 9.1.0)
        message(FATAL_ERROR "H5PP_ENABLE_FMT: Found version ${FMT_VERSION} < 9.1.0 required by h5pp")
    endif()
...
if(H5PP_ENABLE_SPDLOG)
    ...
    if(SPDLOG_VERSION AND SPDLOG_VERSION VERSION_LESS 1.12.0)
        message(FATAL_ERROR "H5PP_ENABLE_SPDLOG: Found version ${SPDLOG_VERSION} < 1.12.0 required by h5pp")
    endif()
...
# We currently promise the Ubuntu 24 baseline and newer for packaged HDF5 installs.
find_package(HDF5 COMPONENTS C HL REQUIRED)
target_link_libraries(deps INTERFACE HDF5::HDF5)
if(HDF5_VERSION AND HDF5_VERSION VERSION_LESS 1.10.10)
    message(FATAL_ERROR "Found version ${HDF5_VERSION} < 1.10.10 required by h5pp")
endif()
