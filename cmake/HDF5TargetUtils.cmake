...
function(h5pp_get_modern_hdf5_target_name)
    ...
    foreach (tgt ${HDF5_X_TARGETS};${HDF5_C_TARGET})
        ...
        foreach (ltgt ${HDF5_INTERFACE_LINK_LIBRARIES})
            ...
            if(ltgt MATCHES "libaec::sz|libaec::aec")
                set(HDF5_LIBAEC_REQUIRED REQUIRED)
            endif()
            if(ltgt STREQUAL "aec")
                set(HDF5_libaec_REQUIRED REQUIRED)
            endif()
    ...
    find_package(libaec ${HDF5_LIBAEC_REQUIRED} CONFIG BYPASS_PROVIDER)
    find_library(LIBRARY_Z z ${HDF5_z_REQUIRED} QUIET)
    find_library(LIBRARY_SZ sz ${HDF5_sz_REQUIRED} QUIET)
    find_library(LIBRARY_libaec sz ${HDF5_libaec_REQUIRED} QUIET)
endfunction()