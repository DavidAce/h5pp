function(h5pp_make_hdf5_target)
    if(TARGET HDF5::HDF5)
        ...
        get_target_property(H5PP_HDF5_IMPORTED_LOCATION HDF5::HDF5 LOCATION)
        get_target_property(H5PP_HDF5_INTERFACE_LINK_LIBRARIES HDF5::HDF5 INTERFACE_LINK_LIBRARIES)
    ...
    foreach(lib  ${H5PP_HDF5_IMPORTED_LOCATION} ${H5PP_HDF5_LINK_LIBRARIES} ${HDF5_LIBRARIES})
        if(NOT lib)
            continue()
        endif()
...
#        message(STATUS "Linking HDF5::HDF5 with [${name}]: ${lib}")
        if(TARGET ${lib})
#             target_link_libraries(HDF5::HDF5 INTERFACE ${lib})
             list(APPEND H5PP_HDF5_LINK_TGTS ${lib})
        elseif(TARGET ${name})
#             target_link_libraries(HDF5::HDF5 INTERFACE ${name})
             list(APPEND H5PP_HDF5_LINK_TGTS ${name})
        elseif(TARGET hdf5::${name})
#             target_link_libraries(HDF5::HDF5 INTERFACE hdf5::${name})
             list(APPEND H5PP_HDF5_LINK_TGTS hdf5::${name})
...
#                    target_link_libraries(HDF5::HDF5 INTERFACE aec)
    ...
    foreach(tgt ${H5PP_HDF5_LINK_TGTS})
        foreach(lib ${H5PP_HDF5_LINK_LIBS})
